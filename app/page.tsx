    ...
    <>
      <main className="min-h-screen flex_center p-4">
        <section className="max-w-xl text-center">
          <Badge />
          <h1 className="font-extrabold text-4xl md:text-6xl tracking-[-1px] md:tracking-[-4px]">
            Join the <br className="sm:hidden"/>waitlist!
          </h1>
          <p className="font-medium mt-4 text-[0.88rem] md:text-base px-4">
